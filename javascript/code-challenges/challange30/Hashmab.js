...
// const HashTable = new Hashmap(19);// console.log(HashTable.hash("Rama")); // Rama saved --> index 12// HashTable.set("Saleh", "Student");
...
// console.log(HashTable.has("soso"));// console.log(
