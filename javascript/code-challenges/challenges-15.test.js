...
const toTitleCase = (arr) => {
  ...
  for(let i = 0; i < arr.length; i++){
    ...
    arrToReturn.push(splitWord.join(''));
  }
  return arrToReturn;
};
...
const detectTicTacToeWin = (board) => {
  const helpCheck = (row1, culumn1, row2, culumn2, row3, culumn3) => {
    let result;
    if (board[row1][culumn1] === board[row2][culumn1] && board[row1][culumn1] === board[row3][culumn1]){
      result = true;
    } else if (board[row1][culumn2] === board[row2][culumn2] && board[row1][culumn2] === board[row3][culumn2]){
      result =  true;
    } else if (board[row1][culumn3] === board[row2][culumn3] && board[row1][culumn3] === board[row3][culumn3]){
      result =  true;
    } else if (board[row1][culumn1] === board[row2][culumn2] && board[row1][culumn1] === board[row3][culumn3]){
      result =  true;
    } else if (board[row1][culumn3] === board[row2][culumn3] && board[row1][culumn3] === board[row3][culumn1]){
      result =  true;
    } else if (board[row2][culumn1] === board[row2][culumn2] && board[row2][culumn1] === board[row2][culumn3]){
      result =  true;
    } else if (board[row3][culumn1] === board[row3][culumn2] && board[row3][culumn1] === board[row3][culumn3]){
      result =  true;
    } else {
      result =  false;
    }
